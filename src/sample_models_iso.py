...
testSets = {
        "zInterp":
            TurbulenceDataset("Test Z Slice 200-300", ["data"], filterTop=["128_iso"], filterSim=[[200,210,220,230,240,250,260,270,280,290,300,310,320,330,340,350]],
                    filterFrame=[(500,600)], sequenceLength=[[100,1]], simFields=["velZ", "pres"], simParams=[], printLevel="sim"),
}
dataTransformationFieldIndices = [0,1,2,3] # ORDER (fields): velocity (x,y), velocity z / density, pressure, ORDER (params): rey, mach, zslice
