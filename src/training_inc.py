...
if __name__ == "__main__":
    ...
    ### UNET
    modelName = "2D_Inc/128_unet-m2_MSE"
    ...
    ### UNET_ut
    # modelName = "2D_Inc/128_unet-m8_MSE"
    ...
    ### UNET_tn
    # modelName = "2D_Inc/128_unet-m2-noise0.01_MSE"
    # p_d = DataParams(batch=64, augmentations=["normalize"], sequenceLength=[2,2], randSeqOffset=True,
    #             dataSize=[128,64], dimension=2, simFields=["pres"], simParams=["rey"], normalizeMode="incMixed")
    # p_t = TrainingParams(epochs=1000, lr=0.0001)
    # p_l = LossParams(recMSE=0.0, recLSIM=0.0, predMSE=1.0, predLSIM=0.0)
    ...
    ### RESNET
    # modelName = "2D_Inc/128_resnet-m2_MSE"
    # p_d = DataParams(batch=64, augmentations=["normalize"], sequenceLength=[2,2], randSeqOffset=True,
    #             dataSize=[128,64], dimension=2, simFields=["pres"], simParams=["rey"], normalizeMode="incMixed")
    # p_t = TrainingParams(epochs=1000, lr=0.0001)
    # p_l = LossParams(recMSE=0.0, recLSIM=0.0, predMSE=1.0, predLSIM=0.0)
    ...
    ### RESNET_dil.
    # modelName = "2D_Inc/128_dil-resnet-m2_MSE"
    # p_d = DataParams(batch=64, augmentations=["normalize"], sequenceLength=[2,2], randSeqOffset=True,
    #             dataSize=[128,64], dimension=2, simFields=["pres"], simParams=["rey"], normalizeMode="incMixed")
    # p_t = TrainingParams(epochs=1000, lr=0.0001)
    # p_l = LossParams(recMSE=0.0, recLSIM=0.0, predMSE=1.0, predLSIM=0.0)
    ...
    ### FNO_16
    # modelName = "2D_Inc/128_fno-16modes-m2_MSE"
    # p_d = DataParams(batch=64, augmentations=["normalize"], sequenceLength=[2,2], randSeqOffset=True,
    #             dataSize=[128,64], dimension=2, simFields=["pres"], simParams=["rey"], normalizeMode="incMixed")
    ...
    ### FNO_32
    # modelName = "2D_Inc/128_fno-32modes-m2_MSE"
    # p_d = DataParams(batch=64, augmentations=["normalize"], sequenceLength=[2,2], randSeqOffset=True,
    #             dataSize=[128,64], dimension=2, simFields=["pres"], simParams=["rey"], normalizeMode="incMixed")
    # p_t = TrainingParams(epochs=2000, lr=0.0001)
    # p_l = LossParams(recMSE=0.0, recLSIM=0.0, predMSE=1.0, predLSIM=0.0)
    ...
    ### TF_Enc
    # modelName = "2D_Inc/128_tf-enc_MSE"
    ...
    ### TF_VAE
    # modelName = "2D_Inc/128_tf-vae_MSE"
    # p_d = DataParams(batch=8, augmentations=["normalize"], sequenceLength=[60,2], randSeqOffset=True,
    #             dataSize=[128,64], dimension=2, simFields=["pres"], simParams=["rey"], normalizeMode="incMixed")
    # p_t = TrainingParams(epochs=5000, lr=0.0001, fadeInSeqLen=[300,1200], fadeInSeqLenLin=True)
    ...
    ### TF_MGN
    # modelName = "2D_Inc/128_tf-mgn_MSE"
    # p_d = DataParams(batch=8, augmentations=["normalize"], sequenceLength=[60,2], randSeqOffset=True,
    #             dataSize=[128,64], dimension=2, simFields=["pres"], simParams=["rey"], normalizeMode="incMixed")
    # p_t = TrainingParams(epochs=5000, lr=0.0001, fadeInSeqLen=[300,1200], fadeInSeqLenLin=True)
    # p_l = LossParams(recMSE=1.0, recLSIM=0.0, predMSE=1.0, predLSIM=0.0)
