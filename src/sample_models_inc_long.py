...
testSets = {
    "highRey" :
        TurbulenceDataset("Test High Reynolds 900-1000", ["data"], filterTop=["128_inc"], filterSim=[[0,2,4]],
                filterFrame=[(300,1300)], sequenceLength=[[500,2]], simFields=["pres"], simParams=["rey"], printLevel="sim"),
}
